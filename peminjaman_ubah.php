        ...
        <div class="col-md-12">
          <form action="" method="post">
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-8">
                <input type="date" value="<?php echo $data['tanggal_pengembalian']; ?>" name="tanggal_peminjaman" id=""
                  class="form-control">
              </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-8">
                <input type="number" value="<?php echo $data['total_pinjam']; ?>" name="total_pinjam" id=""
                  class="form-control">
              </div>
            </div>
            <div class="row mb-3">
